...
-- Sun 19 Feb 2017 04:26:45 PM CET
...
CREATE TABLE IF NOT EXISTS `mydb`.`medewerkers` (
  ...
  `FK_medewerkers_accounts_id` INT NOT NULL,
  `email` VARCHAR(45) NULL,
  `voornaam` VARCHAR(45) NULL,
  `tussenvoegsel` VARCHAR(45) NULL,
  `achternaam` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`medewerkers_id`, `FK_medewerkers_accounts_id`),
  INDEX `fk_Medewerker_Account1_idx` (`FK_medewerkers_accounts_id` ASC),
  CONSTRAINT `FK_medewerkers_accounts_id`
    FOREIGN KEY (`FK_medewerkers_accounts_id`)
...
CREATE TABLE IF NOT EXISTS `mydb`.`adressen` (
  ...
  PRIMARY KEY (`adressen_id`, `adressen_type`, `FK_adressen_klanten_id`),
...
CREATE TABLE IF NOT EXISTS `mydb`.`bestelregels` (
  `bestelregels_id` INT NOT NULL AUTO_INCREMENT,
  `FK_bestelregels_bestellingen_id` INT NOT NULL,
  `FK_bestelregels_producten_id` INT NOT NULL,
  `hoeveelheid` INT NOT NULL,
  INDEX `idBestelling_idx` (`FK_bestelregels_bestellingen_id` ASC),
  PRIMARY KEY (`bestelregels_id`),
  INDEX `FK_bestellingregels_producten_id_idx` (`FK_bestelregels_producten_id` ASC),
  CONSTRAINT `FK_bestellingregels_producten_id`
    FOREIGN KEY (`FK_bestelregels_producten_id`)
    REFERENCES `mydb`.`producten` (`producten_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `FK_bestellingregels_bestellingen_id`
    FOREIGN KEY (`FK_bestelregels_bestellingen_id`)
...
CREATE TABLE IF NOT EXISTS `mydb`.`facturen` (
  ...
  `FK_facturen_klanten_id` INT NOT NULL,
  ...
  INDEX `FK_facturen_klanten_id_idx` (`FK_facturen_klanten_id` ASC),
  ...
  CONSTRAINT `FK_facturen_adressen_id`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `FK_facturen_klanten_id`
    FOREIGN KEY (`FK_facturen_klanten_id`)
    REFERENCES `mydb`.`klanten` (`klanten_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
